...
const Testomonial = () => {
    ...
    { name: "Ava Johnson",
        ...
        image: assets.testimonial_image_1, 
        testimonial: "I highly recommend Carrental ! their fleet is amazing , and I always feel like I'm getting the best with excellent service . "
    }, 
];
  return (
    <div className='py-28 px-6 md:px-16 lg:px-24 xl:px-44'>
        ...
        choose StayVenture for their luxury accommodations around the world. "/>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-18">
