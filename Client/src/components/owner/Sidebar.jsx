  ...
  return (
    ...
    md:max-w-60 w-full border-r border-borderColor text-sm '>
        ...
        <div className='group relative'>
            <label htmlFor="image">
                <img src={image ? URL.createObjectURL(image) : user?.image || "https://images.unsplash.com/photo-163332755192-727a05c4013d?q=80&w=300"} 
                ...
                <div className='absolute hidden top-0 right-0 left-0 bottom-0
                 bg-black/10 rounded-b-full group-hover:flex items-center
        ...
        {image && (
            <button>Save <img src={assets.check_icon} width = {13} alt="" onClick={updateImage}/></button>
        )}
